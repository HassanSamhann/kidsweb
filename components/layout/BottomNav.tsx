...
export function BottomNav() {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 max-w-md md:max-w-3xl lg:max-w-5xl xl:max-w-7xl mx-auto bg-white rounded-t-3xl shadow-[0_-4px_10px_rgba(0,0,0,0.05)] border-t border-gray-100 z-50">
