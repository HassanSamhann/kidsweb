  ...
  useEffect(() => {
    ...
    function update() {
      ...
      if (np) {
        ...
        const now = new Date();
        const [h, m] = timings[np.key as keyof PrayerTimings]
          .split(":")
          .map(Number);
        ...
        <div className="max-w-2xl mx-auto space-y-6">
          ...
          <div className="relative">
            ...
            >
              ...
              <ChevronDown
                className={`w-5 h-5 text-gray-400 transition-transform ${showCityMenu ? "rotate-180" : ""}`}
              />
            </button>
          ...
          {nextPrayer && countdown && (
            <div className="bg-gradient-to-br from-amber-600/20 to-amber-700/10 rounded-[2rem] p-6 border border-amber-500/30 text-center">
              <p className="text-gray-400 text-sm mb-2">
                متبقي على صلاة {PRAYER_NAMES[nextPrayer]?.ar}
              </p>
              <p
                className="text-4xl font-black text-amber-400 font-sans tracking-widest"
                dir="ltr"
              >
                {countdown}
              </p>
              ...
              return (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`text-xl font-black font-sans tracking-wide ${
